--
-- Marrowthrall polish: scale, charge, Bone Storm (VFX + periodic AoE), taunt.
-- Fixes:
--   * DisplayScale 0.35 -> 0.50 (read as slightly larger than a player)
...
(90012,327696,0,0,0,0,1,0,45000,0,0,101,1,1,32,0,0,1,-1,6,6,0,1,1,0,0,49,0,1000,0,90017,0,1,1,0,0,0,23,138,0,0,0,0,0,0,10704,2836,"Bone Storm","","The Marrowthrall whirls in a storm of bone, damaging nearby enemies every second and attacking faster for $d.",0,0,0,1,1,1,1,0,0),
...
(90014,0,136,67108864,0,0,1,0,120000,84,0,101,1,1,0,0,100,1,-1,63,0,0,1,0,0,1674,0,0,0,0,0,0,22,0,0,15,0,0,0,0,13,0,0,0,0,71,9,"Rattle the Bones","","Forces all enemies within $a1 yards to attack the Marrowthrall.",5,1,1,32,1,1,1,0,0),
