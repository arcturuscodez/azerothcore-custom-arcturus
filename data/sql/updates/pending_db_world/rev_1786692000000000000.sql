...
-- 90030 was cloned from Prowl with Stances=1 (FORM_CAT). Openers inherited FORM_STEALTH
-- stance masks. Clear all stance requirements; keep MOD_STEALTH + speed + bar remap.
