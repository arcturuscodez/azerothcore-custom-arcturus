...
void SpellMgr::LoadSpellInfoCorrections()
{
    ...
    // Custom/warlock_demonic_empowerment.cpp); AMS also rides on the Frostmourne Shard
    // legendary trinket. Their costs are paid in runic power, which no other class has —
    // zero the cost so a warlock can cast them. Side effect: death knights cast them
    // cost-free too, which is acceptable on this solo-progression fork.
